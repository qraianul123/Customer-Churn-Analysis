...
The data paints a clear and consistent picture. The customers most likely to churn are new, on flexible contracts and paying a premium for fibre optic service. Almost 50% of all customers churn in the first year and month-to-month subscribers churn at a staggering 40%, over 14 times the churn rate of customers on 2 year contracts. The really scary part is churned customers are paying more per month ($74 vs $61) which means the company is losing its highest paying customers the fastest. The business's premium tier, fiber optic subscribers, churn at 42%, more than double the rate of DSL customers. It says the problem is not price sensitivity, it is perceived value. Consumers are willing to pay a premium, but something about the experience, whether it's the quality of service, unmet expectations or tougher competition, is pushing them out the door before they even get to their first year. The best way to reduce churn is to optimize the first 12 months. Enhance onboarding, advocate for extended term contracts and discover the root cause of dissatisfaction in the fiberoptic segment.
